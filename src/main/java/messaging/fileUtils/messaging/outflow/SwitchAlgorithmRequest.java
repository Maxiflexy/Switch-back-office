...
public class SwitchAlgorithmRequest extends RequestValidator implements RequestExecutor {
    ...
    public String execute(String request, String currentUser, String actionId) {
        ...
        requestBean.setString("action", OutflowSwitchAction.CREATE.getName());
