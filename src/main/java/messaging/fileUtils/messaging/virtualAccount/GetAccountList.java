...
public class GetAccountList implements RequestExecutor {

    @Override
    public String execute(String request, String currentUser, String actionId) {
        BaseBean requestBean = new BaseBean();
        requestBean.setString("user", currentUser);
        boolean error = AccountDbHelper.getApprovedAccounts(requestBean, JsonUtil.toJsonObject(request));
    ...
    public String createReply(BaseBean requestBean, boolean success) {
        ...
        String message = "Successfully fetched account configs";
