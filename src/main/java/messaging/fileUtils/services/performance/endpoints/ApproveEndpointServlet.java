package messaging.fileUtils.services.performance.endpoints;

import messaging.fileUtils.exceptions.CustomException;
import messaging.fileUtils.messaging.stats.endpoints.ApproveEndpoint;
import messaging.fileUtils.services.servlets.CustomBaseServlet;
...
public class ApproveEndpointServlet extends CustomBaseServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest servletRequest, HttpServletResponse servletResponse) throws IOException {
        ...
        try {
            ...
            if (APPLICATION_JSON.equalsIgnoreCase(getContentType())) {
                ...
                setExecutor(new ApproveEndpoint());
