package messaging.fileUtils.services.virtualaccount;

import messaging.fileUtils.messaging.virtualAccount.ApproveAccount;
...
public class ApproveVirtualAccountServlet extends CustomBaseServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest servletRequest, HttpServletResponse servletResponse) throws IOException {
        ...
        try {
            ...
            if (APPLICATION_JSON.equalsIgnoreCase(getContentType())) {
                ...
                setExecutor(new ApproveAccount());
