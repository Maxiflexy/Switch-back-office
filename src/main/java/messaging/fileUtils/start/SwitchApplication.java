package messaging.fileUtils.start;

import messaging.fileUtils.filters.AuthorizationFilter;
import messaging.fileUtils.filters.CORSFilter;
import messaging.fileUtils.filters.TokenInvalidationFilter;
import messaging.fileUtils.filters.ValidateTokenFilter;
import messaging.fileUtils.service.servlet.*;
import messaging.fileUtils.services.*;
import messaging.fileUtils.services.fileservlets.Approveupload;
import messaging.fileUtils.services.fileservlets.UploadServlet;
import messaging.fileUtils.services.outflow.OutflowSwitchSequence;
import messaging.fileUtils.services.outflow.SwitchAlgorithmController;
import messaging.fileUtils.services.performance.PerformanceServlet;
import messaging.fileUtils.services.performance.endpoints.ApproveEndpointServlet;
import messaging.fileUtils.services.performance.endpoints.Endpoint;
import messaging.fileUtils.services.serviceProvider.ApproveServiceServlet;
import messaging.fileUtils.services.serviceProvider.Service;
import messaging.fileUtils.services.switchController.ApproveSwitchServlet;
import messaging.fileUtils.services.switchController.Switch;
import messaging.fileUtils.services.transactions.BatchApprovalServlet;
import messaging.fileUtils.services.transactions.FailedRetrialServlet;
import messaging.fileUtils.services.transactions.PendingTransactionServlet;
import messaging.fileUtils.services.virtualaccount.ApproveVirtualAccountServlet;
import messaging.fileUtils.services.virtualaccount.VirtualAccount;
import messaging.fileUtils.util.Encrypter;
...
//            MultipartConfigElement configElement = new MultipartConfigElement("C:/uploads", 10485760, 52428800, 10240);
            ...
            Tomcat.addServlet(context, "FetchPendingTransactionServlet", new messaging.fileUtils.services.PendingTransactionServlet());
