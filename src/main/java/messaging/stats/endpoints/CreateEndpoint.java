...
public class CreateEndpoint extends RequestValidator implements RequestExecutor {
    final static Logger LOG = LogManager.getLogger(CreateEndpoint.class);
    ...
    public boolean validateRequest(BaseBean requestBean, String request) {
        ...
        try {
            ...
            validateParameter(jsonRequest, requestBean, "endpoint-name");
            validateParameter(jsonRequest, requestBean, "endpoint-code");
            response = true;
        } catch (Exception Ex) {
