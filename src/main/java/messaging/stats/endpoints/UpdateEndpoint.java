...
public class UpdateEndpoint extends RequestValidator implements RequestExecutor {

    final static Logger LOG = LogManager.getLogger(UpdateEndpoint.class);
    ...
    public boolean validateRequest(BaseBean requestBean, String request) {
        ...
        try {
            ...
            validateOptionalParameter(jsonRequest, requestBean, "endpoint-name", true);
            validateOptionalParameter(jsonRequest, requestBean, "endpoint-code", true);
