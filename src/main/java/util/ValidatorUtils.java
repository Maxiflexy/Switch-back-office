...
public class ValidatorUtils {
    protected final static Logger LOG = LogManager.getLogger(ValidatorUtils.class);
    ...
    protected void validateBillerId(JsonObject jobj, BaseBean valBean) throws IOException {
        String attribute = "billerId";
        doParameterCheck(jobj, valBean, attribute, ResponseUtil.INVALID_BILLER_ID);

    }

    protected void validateSessionId(JsonObject jobj, BaseBean valBean) throws IOException {
    ...
    protected void validateTransactionRequest(JsonObject jobj, BaseBean valBean) throws IOException {
